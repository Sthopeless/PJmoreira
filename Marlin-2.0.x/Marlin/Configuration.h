...
#define STRING_CONFIG_H_AUTHOR "(PJmoreira, TwoTree BlueR)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PJmoreira"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 41, 0, -1.80 }
